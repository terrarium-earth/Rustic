...
public class ModBlocks {
    ...
    public static final RegistryEntry<Block> IRONWOOD_SIGN = BLOCKS.register("ironwood_sign", () -> new StandingSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SIGN), IRONWOOD_SIGN_TYPE));
    public static final RegistryEntry<Block> IRONWOOD_WALL_SIGN = BLOCKS.register("ironwood_wall_sign", () -> new WallSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WALL_SIGN), IRONWOOD_SIGN_TYPE));
    ...
    public static final RegistryEntry<Block> OLIVEWOOD_SIGN = BLOCKS.register("olivewood_sign", () -> new StandingSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SIGN), OLIVEWOOD_SIGN_TYPE));
    public static final RegistryEntry<Block> OLIVEWOOD_WALL_SIGN = BLOCKS.register("olivewood_wall_sign", () -> new WallSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WALL_SIGN), OLIVEWOOD_SIGN_TYPE));
